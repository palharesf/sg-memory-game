...
export const POOL: PoolImage[] = [
  ...
  img("delapouite", "i-brick.png"),
  img("delapouite", "j-brick.png"),
  img("delapouite", "l-brick.png"),
  img("delapouite", "level-end-flag.png"),
  img("delapouite", "o-brick.png"),
  img("delapouite", "s-brick.png"),
