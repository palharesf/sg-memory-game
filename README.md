...
- Players can now view secrets for games they've already won directly from the /history page — click the key icon in the Games Won table, no need to revisit each game page (aez76)
